...
// (DO NOT EDIT: machine generated header) 'auAutoUpgraderWizard.pas' rev: 4.00
...
public:
	...
	/* TCustomForm.Create */ inline __fastcall virtual TauAutoUpgraderWizardForm(Classes::TComponent* AOwner
		) : Forms::TForm(AOwner) { }
	#pragma option pop
	#pragma option push -w-inl
	/* TCustomForm.CreateNew */ inline __fastcall virtual TauAutoUpgraderWizardForm(Classes::TComponent* 
...
public:
	#pragma option push -w-inl
	/* TWinControl.CreateParented */ inline __fastcall TauAutoUpgraderWizardForm(HWND ParentWindow) : Forms::TForm(
		ParentWindow) { }
	#pragma option pop
