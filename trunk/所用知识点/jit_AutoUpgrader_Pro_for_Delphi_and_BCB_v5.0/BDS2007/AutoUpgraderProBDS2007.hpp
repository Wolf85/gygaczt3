...
// (DO NOT EDIT: machine generated header) 'Autoupgraderprobds2007.pas' rev: 11.00

#ifndef Autoupgraderprobds2007HPP
#define Autoupgraderprobds2007HPP
...
#include <Auautoupgraderaddurl.hpp>	// Pascal unit
#include <Auautoupgradereditor.hpp>	// Pascal unit
#include <Auautoupgraderpassword.hpp>	// Pascal unit
#include <Auautoupgraderupgrademsg.hpp>	// Pascal unit
#include <Auautoupgraderwizard.hpp>	// Pascal unit
#include <Auextassociation.hpp>	// Pascal unit
#include <Auhttp.hpp>	// Pascal unit
#include <Auhttpproxyeditor.hpp>	// Pascal unit
#include <Authread.hpp>	// Pascal unit
#include <Auutils.hpp>	// Pascal unit
#include <_aureg.hpp>	// Pascal unit
...
namespace Autoupgraderprobds2007
{
//-- type declarations -------------------------------------------------------
//-- var, const, procedure ---------------------------------------------------

}	/* namespace Autoupgraderprobds2007 */
using namespace Autoupgraderprobds2007;
#pragma pack(pop)
#pragma option pop

#pragma delphiheader end.
//-- end unit ----------------------------------------------------------------
#endif	// Autoupgraderprobds2007
