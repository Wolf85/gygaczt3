...
// (DO NOT EDIT: machine generated header) 'auAutoUpgraderUpgradeMsg.pas' rev: 4.00
...
public:
	...
	/* TCustomForm.Create */ inline __fastcall virtual TauAutoUpgraderUpgradeMessageForm(Classes::TComponent* 
		AOwner) : Forms::TForm(AOwner) { }
	#pragma option pop
	#pragma option push -w-inl
	/* TCustomForm.CreateNew */ inline __fastcall virtual TauAutoUpgraderUpgradeMessageForm(Classes::TComponent* 
...
public:
	#pragma option push -w-inl
	/* TWinControl.CreateParented */ inline __fastcall TauAutoUpgraderUpgradeMessageForm(HWND ParentWindow
