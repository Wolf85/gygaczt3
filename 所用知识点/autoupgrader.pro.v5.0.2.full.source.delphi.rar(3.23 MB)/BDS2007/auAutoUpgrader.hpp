...
// (DO NOT EDIT: machine generated header) 'Auautoupgrader.pas' rev: 11.00
...
enum TauAutoUpgraderLanguage { wlAuto, wlEnglish, wlRussian, wlGerman, wlFrench, wlSpanish, wlPortuguese, wlPortugueseBrazilian, wlItalian, wlDutch, wlDanish, wlSwedish, wlFinnish, wlEstonian, wlUkrainian, wlPolish, wlCzech, wlHungarian, wlRomanian, wlCatalan, wlBasque, wlAfrikaans, wlChineseTraditional, wlChineseSimplified, wlIndonesian, wlMalay, wlIcelandic, wlTurkish, wlNorwegian, wlSlovak };
#pragma option pop
...
typedef void __fastcall (__closure *TAUBeginUpgradeEvent)(System::TObject* Sender, const AnsiString UpgradeMsg, TacUpgradeMethod UpgradeMethod, Auutils::TauStringList* Files, bool &CanUpgrade);

typedef void __fastcall (__closure *TAUEndUpgradeEvent)(System::TObject* Sender, bool &RestartImediately);

typedef void __fastcall (__closure *TAUFileStartEvent)(System::TObject* Sender, const AnsiString FileURL, int FileSize, const System::TDateTime FileTime, bool &CanUpgrade);
...
private:
	...
	void __fastcall SafeTerminate(bool Imediately = false);
...
public:
	...
	bool __fastcall CheckUpdate(bool JustCheckIsUpdateAvailable = false);
	HIDESBASE void __fastcall Abort(bool Imediately = false);
...
extern PACKAGE AnsiString __fastcall AUFmtLangStr(int Ident, System::TVarRec const * Args, const int Args_Size);
